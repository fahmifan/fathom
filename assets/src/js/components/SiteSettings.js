            ...
            <div class="modal">
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <fieldset style={props.site.unsaved ? 'display: none;' : ''}>
                        ...
                        <textarea  class="client-script" ref={this.setTextarea} onFocus={this.handleTextareaClickEvent} readonly="readonly">{`<!-- Fathom - simple website analytics - https://github.com/usefathom/fathom -->
<script>
